...
public class Stat : MonoBehaviour
{
    ...
    public void Init(float _hp, float _mp,float _nh,float _nm, float _de, float _re, float _ad,float _ap, float _speed, float _attackSpeed, float _critical, float _critacalMultiple)
    {
        hp = _hp;
        mp = _mp;
        naturalHP = _nh;
